              ...
              <div className="flex items-center space-x-4">
                <Link to="/dashboard">
                  <motion.div 
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-5 py-2.5 rounded-full bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 text-indigo-600 dark:text-indigo-400 font-semibold hover:bg-slate-50 dark:hover:bg-white/10 hover:border-indigo-200 dark:hover:border-indigo-500/30 transition-all shadow-sm flex items-center gap-2"
                  >
